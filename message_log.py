...
class MessageLog:
    ...
    """For the time being the message log only accrues messages.
    This will be an issue for longer games. At what point are we 
    at risk of going out of memory?
    """
    ...
    def render(
        ...
        `x`, `y`, `width`, `height`, is the rectangular area to render onto
        the console
        """
