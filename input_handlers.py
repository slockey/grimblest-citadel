...
class EventHandler(BaseEventHandler):
    ...
    def handle_action(self, action: Optional[Action]) -> bool:
        ...
        try:
            ...
            return False    # skip enenmy turn on exception
    ...
    def on_render(self, console: tcod.context.Context) -> None:
...
class LevelUpEventHandler(AskUserEventHandler):
    ...
    def ev_mousebuttondown(self, event: "tcod.event.MouseButtonDown") -> Optional[ActionOrHandler]:
        """
        Don't allow the player to exit the menu, like usual
        """
        return None
...
class AreaRangedAttackHandler(SelectIndexHandler):
    """
    handles targetting an area within a given radius. any entity within 
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        # draw a rectangle around the target area, so the player can see the affected area
        # TODO: this should be less blocky!
        console.draw_frame(
            x=x - self.radius - 1,
            y=y - self.radius - 1,
            width=self.radius ** 2,
...
class MainGameEventHandler(EventHandler):
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        ...
        # not sure why this is outside the other if/elif/etc block
